  ...
  socket.on('participant-voting-response', function(clientResultValue) {
    ...
    if(clientResultValue === expectedValue) {
      ...
      if (rounds[currentRoundIndex].didSomeoneSendMessage) {
        ...
        rejectedParticipantsVotingRound = [...rejectedParticipantsVotingRound, senderClient];
      } else {
        senderClient.roundMessage = clientResultValue;
...
function communicateIfAnyRejected() {
  if(rejectedParticipantsVotingRound.length) {
    rejectedParticipantsVotingRound.forEach(function(rejectedClient, index, arr) {
...
function addPendingParticipants() {
  ...
  pendingParticipants.forEach(function (pendingClient, index, array) {
