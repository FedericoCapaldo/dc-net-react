...
function generateAndExchangeKeys(adjacencies) {
  ...
  adjacencies.forEach(function(adjacency, index, array){
    Promise.try(function() {
      ...
      unicastMessageWithType(adjacency.participant1.id, 'key-exchange', keyName1, number);
      unicastMessageWithType(adjacency.participant2.id, 'key-exchange', keyName2, number);
